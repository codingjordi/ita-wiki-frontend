...
type ItaBtnVariant = "default" | "primary" | "secondary" | "github" | "close" | "icon" | "custom";
...
const classList = {
    ...
    close: "inline-flex items-center justify-center w-[21px] h-[19px] text-[#282828] bg-transparent border-none hover:duration-100 will-change-transform hover:opacity-50 outline-none cursor-pointer box-sizing m-[10px]",
...
const ButtonComponent: FC<ItaButtonProps> = ({ children, variant, text, icon, type, className, onClick }) => {
    const baseClass = variant === "custom" ? className || "" : classList[variant ?? "default"];
