...
describe('Render Button', () => {
    ...
    it("should have primary classes", () => {
        ...
        expect(button).toBeInTheDocument();
        expect(button).toHaveClass('block', 'w-full', 'h-[63px]', 'bg-[#B91879]', 'hover:bg-[#c44d95]');
    });
    it("should have secondary classes", () => {
        ...
        expect(button).toBeInTheDocument();
        expect(button).toHaveClass('block', 'w-full', 'text-[#7e7e7e] ', 'h-[63px]', 'bg-[#fff]', 'hover:bg-[#dcdcdc]');
    });
    it("should be close button", () => {
        ...
        expect(button).toBeInTheDocument();
        expect(button).toHaveClass('inline-flex', 'w-[21px]', 'h-[19px]', 'text-[#282828]');
    ...
    it("should be custom button", () => {
        ...
        render(<ButtonComponent text="boton customizado" variant="custom" className='bg-[#33df72] text-white p-4' />)
        const button = screen.getByRole('button');
