...
export const resourceSchema: z.ZodType<Partial<IntResource>> = z.object({
  ...
  category: z.enum(categories, { message: "Por favor, selecciona una categoría válida." }),

  theme: z.enum(themes, { message: "Por favor, selecciona un tema válido" }),

  type: z.enum(resourceTypes, { message: "Debes seleccionar al menos un tipo de recurso." })
});
