export const TermsAndConditionsData = () => {
    return (
        <section className="text-gray-800">
            ...
            <h3 className="font-semibold mt-6 mb-2">1. Aceptación de las condiciones</h3>
            <p className="mb-4">
                1. El acceso y/o uso de la Wiki atribuye la condición de “Usuario” y supone la aceptación plena de estos términos.
            </p>

            <h3 className="font-semibold mt-6 mb-2">2. Naturaleza de los contenidos</h3>
            <p className="mb-2">
            ...
            <p className="mb-4">La Academia no edita ni modera previamente los enlaces publicados.</p>

            <h3 className="font-semibold mt-6 mb-2">3. Registro y acceso</h3>
            <p className="mb-2">El alta está limitada a estudiantes y personal docente de la Academia.</p>
            ...
            <ul className="list-disc list-inside mb-4">
                <li>Publicar enlaces a contenidos ilícitos, difamatorios, violentos, discriminatorios o que infrinjan derechos de terceros.</li>
                <li>Realizar spam o cualquier uso que dificulte el normal funcionamiento de la Wiki.</li>
            </ul>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Política de Privacidad (RGPD / LOPDGDD)</h2>

            <h3 className="font-semibold mt-6 mb-2">Datos recogidos:</h3>
            <p className="mb-4">Nombre, apellidos, dirección de correo institucional y registros de actividad (logs).</p>

            <h3 className="font-semibold mt-6 mb-2">Finalidad:</h3>
            <p className="mb-4">Gestión de cuentas de usuario y trazabilidad de las contribuciones.</p>

            <h3 className="font-semibold mt-6 mb-2">Base jurídica:</h3>
            <p className="mb-4">Relación contractual (art. 6.1.b RGPD) y obligación legal (art. 6.1.c RGPD).</p>

            <h3 className="font-semibold mt-6 mb-2">Cesiones / Encargados:</h3>
            <p className="mb-4">Proveedores de alojamiento y servicios tecnológicos, con los contratos de encargo correspondientes.</p>
            ...
            <p className="mb-4">Cifrado de contraseñas, control de accesos y auditorías periódicas.</p>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Política de Enlaces y Exención de Responsabilidad</h2>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Normas de Participación (“Código de Conducta”)</h2>
            <ul className="list-disc list-inside mb-4">
                ...
                <li>Etiquetar los enlaces con la categoría/herramienta/curso correspondiente.</li>
                <li>Abstenerse de compartir material que requiera licencias no autorizadas.</li>
            </ul>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Procedimiento de “Notificación y Retirada” (Notice & Takedown)</h2>
            <ul className="list-disc list-inside mb-4">
                <li>Comunicación escrita con los datos del reclamante, identificación del enlace controvertido y fundamento jurídico de la infracción alegada.</li>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Limitación de Responsabilidad</h2>
            <ul className="list-disc list-inside mb-4">
                <li>Falta de disponibilidad de la plataforma por causas técnicas o de mantenimiento.</li>
