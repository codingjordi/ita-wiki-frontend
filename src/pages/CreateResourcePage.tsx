  ...
  return (
    <div className='w-full'>
      ...
      <form className='my-5 space-y-3.5 w-1/2 bg-white p-10 rounded-xl'>
        ...
        <div className='mt-12'>
          <ButtonComponent className='outline-[#B91879]' children='Crear' variant='primary' onClick={() => handleSubmitFormData()}/>
          <ButtonComponent className='outline-[#B91879]' children='Cancelar' variant='secondary' />
        </div>
      </form>
    </div>
  );
